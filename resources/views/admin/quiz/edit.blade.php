        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('quizzes.update', $quiz->id) }}">
                ...
                <div class="mb-3 form-group">
                    ...
                    <textarea type="text" name="descr" id="descr" class="form-control" placeholder=""
                        rows="7">{{ $quiz->descr }}</textarea>
                </div>
                <div class="mb-3 form-group">
                    <input type="checkbox" id="isFinished" @if ($quiz->finished_at) checked @endif class="mt-1 form-check-input mt-0">
                    <label for="finished_at" class="form-label">Bitiş Tarihi</label>
                </div>
                <div id="finishedInput" @if (!$quiz->finished_at)   style="display: none" @endif class="mb-3 form-group">
